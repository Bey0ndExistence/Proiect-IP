        ...
        static async Task Main(string[] args)
        {
            ...
            var msgList = new List<Message>
            {
                /*new Message(MessageType.Register, "Marco", "server", new Dictionary<string, string> {{ "username", "Marco" },
                  ...
                  { "lastname", "User" },
                  { "phone_number", "Marco" } }),*/
                new Message(MessageType.Login, "Marco", "server", new Dictionary<string, string>{ { "username", "Marco" }, { "password", "Marco" } }),
                ...
                new Message(MessageType.ChatMsg, "Marco", "Molo", new Dictionary<string, string> { { "message", "Hello, Molo, yo soi Marco!" } }),
                                new Message(MessageType.ChatMsg, "Marco", "Rares", new Dictionary<string, string> { { "message", "Hello, Rares, yo soi Marco!" } }),
                new Message(MessageType.ChatMsg, "Marco", "Molo", new Dictionary<string, string> { { "message", "Hello, Molo, yo soi Marco!" } }),
